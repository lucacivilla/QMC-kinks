...
def plot_k100(df):
    ...
    plt.tight_layout()
    plt.savefig('plots_digital_asian_2/Digital_K100_Analysis.png', dpi=300)
    print("Saved plots_digital_asian_2/Digital_K100_Analysis.png")
...
def plot_k120(df):
    ...
    plt.legend()
    plt.savefig('plots_digital_asian_2/Digital_K120_Variance.png', dpi=300)
    print("Saved plots_digital_asian_2/Digital_K120_Variance.png")
